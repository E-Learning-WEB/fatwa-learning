                ...
                <div class="row"> 
                    ...
                    <div id="logo" class="span4 group">
                        <a id="logo-img" href="../index.php" title="kimia">
                            <img src="../images/celestino1.png" title="kimia" alt="kimia" />                        </a>
...
<div id="page-meta" class="container">
    ...
    <div class="breadcrumbs">
        <p id="yit-breadcrumb" itemprop="breadcrumb">
            ...
            <a class="no-link current" href="tempdata.php">Tambah Forum</a>&gt;
            <a class="no-link current" href="#">Forum</a>
        </p>
    </div>
</div>
<!-- END PAGE META -->
                    ...
                    <div class="recent-post">
                        <div class="post type-post status-publish format-gallery hentry category-web-design group">
                            ...
                            <div class="date">
                                ...
                                <span class="day">8</span>                            </div>

                            <div class="text">
                                <h3>
                                    <a href="../blog-detail.html" title="This is the title of the first article. Enjoy it.">
                                        This is the title of the first article. Enjoy it.                                    </a>                                </h3>
                                <p>by
                            ...
                            <div class="text">
                                <h3>
                                    <a href="#" title="Nice &amp; Clean. The best for your blog!">
                                        Nice &amp; Clean. The best for your blog!                                    </a>                                </h3>
